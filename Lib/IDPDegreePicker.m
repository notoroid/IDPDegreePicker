...
#define IDP_LOW_DEGREE_SLIDER_HEIGHT 72.0f

    const CGFloat sliderheight = self.frame.size.height > IDP_LOW_DEGREE_SLIDER_HEIGHT ?IDP_DEGREE_SLIDER_HEIGHT : IDP_LOW_DEGREE_SLIDER_HEIGHT;
    
    _scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(.0f, self.frame.size.height - sliderheight, 320.0f, sliderheight)];
    _scrollView.contentSize = CGSizeMake(920, sliderheight);
    ...
    UIView* boardView = sliderheight == IDP_DEGREE_SLIDER_HEIGHT ? [[IDPDegreePickerBaseView alloc] init] : [[IDPDegreePickerLowBaseView alloc] init] /*[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"DegreeSliderBase.png"]]*/;
    boardView.frame = CGRectMake(.0f, .0f, 920.0f, sliderheight);
    boardView.opaque = NO;
...
#define IDP_DEGREE_SLIDER_DEGREE 12.0f
    ...
    shadowView.frame = CGRectMake(.0f, .0f, 320.0f, sliderheight);
    ...
    centerView.frame = CGRectMake( 160.0f - 4.0f * .5f,sliderheight - 48.0f , 4.0f, 48.0f);
